...
with open("../../config.json") as f:
    config = json.load(f)
api_list = config['sources']
api_list.extend(config['sinks'])
api_list = [str(i.replace("wx.", "")) if "wx" in i else str(i) for i in api_list]
print(api_list)

base_directory = "/media/dataj/wechat-devtools-linux/testing/auto-testing/miniapp_data/newcrawl/top50/packages_unpack"
# Output JSON file path
output_file = "filter_api_search_results_top50.json"
navigate_output_file = "filter_navigateToMiniProgram_top50.json"
processed_dirs_file = "filter_processed_dirs_top50.txt"  # File to track processed directories
