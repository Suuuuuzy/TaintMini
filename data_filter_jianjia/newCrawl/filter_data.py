...
base_directory = "/media/dataj/wechat-devtools-linux/testing/auto-testing/miniapp_data/newcrawl/pkg_unpack"
# Output JSON file path
output_file = "filter_api_search_results.json"
navigate_output_file = "filter_navigateToMiniProgram.json"
processed_dirs_file = "filter_processed_dirs.txt"  # File to track processed directories
